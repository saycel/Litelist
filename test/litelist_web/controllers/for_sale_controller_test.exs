defmodule LitelistWeb.ForSaleControllerTest do
  ...
  @create_attrs %{contact_info: "some contact_info", description: "some description", price: 120.5, slug: "some slug", title: "some title", url: "some url"}
  @update_attrs %{contact_info: "some updated contact_info", description: "some updated description", price: 456.7, slug: "some updated slug", title: "some updated title", url: "some updated url"}
  # TODO update with validations
  # @invalid_attrs %{contact_info: nil, description: nil, price: nil, slug: nil, title: nil, url: nil}

  def fixture(:for_sale) do
    {:ok, for_sale} = Posts.create_post(@create_attrs)
    for_sale
  end
  ...
  describe "create for_sale" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn = post conn, for_sale_path(conn, :create), post: @create_attrs
    ...
    #   conn = post conn, for_sale_path(conn, :create), post: @invalid_attrs
    #   assert html_response(conn, 200) =~ "New For sale"
    # end
  end
  ...
  describe "update for_sale" do
    ...
    test "redirects when data is valid", %{conn: conn, for_sale: for_sale} do
      conn = put conn, for_sale_path(conn, :update, for_sale), post: @update_attrs
    ...
    #   conn = put conn, for_sale_path(conn, :update, for_sale), post: @invalid_attrs
    #   assert html_response(conn, 200) =~ "Edit For sale"
    # end
  end
