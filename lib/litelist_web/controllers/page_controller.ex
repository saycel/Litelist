defmodule LitelistWeb.PageController do
  ...
  def post_login(conn, %{"neighbor" => %{"username" => username, "password" => password, "create_neighbor" => _create_neighbor}}) do
    Auth.create_neighbor(%{username: username, password: password})
