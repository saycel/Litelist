defmodule LitelistWeb.EmergencyInformationView do
  ...
  def data([]) do
  	%{action: "/emergency_info", fields: build_fields()}
  end
  ...
  def build_fields() do
  	[
  		...
  		%{select: false, title: "ORGINZATION_NAME",type: "text", po_body: "What is the name of this business or company", id: "post_company_name"},
